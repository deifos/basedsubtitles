  ...
  return (
    <section className="relative py-16 sm:py-20">
      <div className="mx-auto max-w-7xl px-6">
        <div className="relative rounded-2xl bg-slate-900 px-8 py-14 sm:px-14 sm:py-16 text-center overflow-hidden shadow-2xl shadow-slate-400/20">
          {/* Dot pattern overlay */}
          <div
          ...
          <div className="relative z-10">
            ...
            <a
              href="#dropzone"
              className="mt-6 inline-flex items-center gap-2 rounded-lg bg-white px-5 py-2.5 text-sm font-semibold text-slate-900 shadow-lg transition-all hover:bg-amber-50 hover:shadow-xl hover:-translate-y-0.5"
              style={{ fontFamily: "var(--font-outfit), sans-serif" }}
            >
